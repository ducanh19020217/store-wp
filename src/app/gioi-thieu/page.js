...
export const metadata = {
    title: "Giới Thiệu - Điện Máy Tổng Hợp Hoàng Lâm | Thiết Bị May Mặc Uy Tín",
    description: "Điện Máy Tổng Hợp Hoàng Lâm - Đơn vị hàng đầu chuyên cung cấp máy may công nghiệp, thiết bị may mặc chính hãng. Hơn 10 năm kinh nghiệm, cam kết chất lượng, giá tốt nhất thị trường.",
    keywords: "máy may công nghiệp, thiết bị may mặc, máy cắt vải, máy thêu vi tính, Hoàng Lâm",
    openGraph: {
        title: "Giới Thiệu - Điện Máy Tổng Hợp Hoàng Lâm",
                ...
                <div className="container-custom text-center">
                    <div className="flex justify-center mb-8">
                        <div className="bg-white p-6 rounded-3xl shadow-2xl">
                            <div className="bg-blue-900 text-white p-4 rounded-full w-24 h-24 flex items-center justify-center font-bold text-4xl italic mx-auto">
                                HL
                            </div>
                        </div>
                    </div>
                    <h1 className="text-5xl md:text-6xl font-black mb-6 uppercase tracking-tight">
                        Điện Máy Tổng Hợp <span className="text-yellow-300">Hoàng Lâm</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {achievements.map((item, index) => (
                            <div key={index} className="text-center group">
                                ...
                                <div className="text-4xl font-black text-red-600 mb-2">{item.number}</div>
            ...
            <section className="py-20">
                <div className="container-custom max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none space-y-6 text-gray-700 leading-relaxed">
                        <p className="text-xl font-medium text-gray-900 first-letter:text-6xl first-letter:font-black first-letter:text-red-600 first-letter:mr-2 first-letter:float-left">
                            Được thành lập với sứ mệnh mang đến những giải pháp thiết bị may mặc toàn diện và chất lượng cao,
                            <strong className="text-red-600"> Điện Máy Tổng Hợp Hoàng Lâm</strong> tự hào là đơn vị tiên phong
                        ...
                        <p>
                            Đội ngũ nhân viên của Hoàng Lâm không chỉ am hiểu sâu sắc về sản phẩm mà còn luôn sẵn sàng tư vấn,
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {values.map((value, index) => (
                            <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-gray-100 group">
                                ...
                                <h3 className="text-2xl font-black mb-4 text-gray-900 group-hover:text-red-600 transition-colors">
                                    {value.title}
                                </h3>
            ...
            <section className="py-20 bg-blue-900 text-white">
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-4xl font-black uppercase mb-8">Tại Sao Chọn Hoàng Lâm?</h2>
            ...
            <section className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
                <div className="container-custom text-center">
                    ...
                    <p className="text-xl mb-10 text-red-100 max-w-2xl mx-auto">
                        Hãy để Hoàng Lâm đồng hành cùng doanh nghiệp bạn trên con đường phát triển và thành công
                    </p>
                    <div className="flex flex-wrap gap-6 justify-center">
                        <Link
                            href="/lien-he"
                            className="bg-white text-red-600 px-10 py-5 rounded-xl font-black text-lg hover:bg-gray-100 transition-all shadow-2xl uppercase tracking-wider"
                        >
                            Liên Hệ Ngay
                        </Link>
                        <a
                            href="tel:0914639068"
                            className="bg-blue-900 text-white px-10 py-5 rounded-xl font-black text-lg hover:bg-blue-800 transition-all shadow-2xl uppercase tracking-wider"
                        >
                            📞 0914 639 068
                        </a>
                    </div>
