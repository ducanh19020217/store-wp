    ...
    <html lang="vi">
      <body className={inter.className}>
        ...
        <div className="fixed bottom-6 left-6 z-[9999] flex flex-col gap-4">
          ...
          <a href={`tel:${siteConfig.contact.phoneRaw}`} className="bg-[#F97316] text-white p-3 rounded-full shadow-lg hover:scale-110 transition-transform flex items-center justify-center w-14 h-14">
